 ...
 *    Loginis: true || false. Bulio algrebra grįstos reikšmės - tiesa, arba melas.
...
console.group('Primityvių kintamųjų kopijavimas');
{
  ...
  console.log('a:', a);
  let b = a;
  console.log('Padaryta a kintamojo kopija į b:', b);
  b = 7;
...
console.group('Nuorodos(objekto) tipo kintamųjų kopijavimas');
{
  ...
  console.log('Pakeitus vieną - keičiasi abu.');
}
console.log('-------------------------');
console.log();
console.groupEnd();
