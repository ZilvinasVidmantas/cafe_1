...
const collectionOptions = [emptyCollectionRef, 'monitorBrands', 'monitorScreenTypes', 'monitorScreenSizes'];
          ...
          </TextField>
          {
            isNewCollection(collectionRef) && (
              <TextField
                ...
                helperText={touched && touched.collectionName && !!errors && errors.collectionName}
              />
            )
          }
        </>
