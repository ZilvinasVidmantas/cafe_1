class LocalStorageService {
  constructor(root) {
    ...
    // Senesnė alternatyvos 4 eilutei 
    { // ↓↓↓↓↓↓↓↓↓↓↓ IŠTRINK MANE ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
      const data = window.localStorage.getItem(root);
    } // ↑↑↑↑↑↑↑↑↑↑↑ IŠTRINK MANE ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    if (data) {
  ...
  synchronize = () => {
    ...
    // Senesnė alternatyvos 25 eilutei 
    { // ↓↓↓↓↓↓↓↓↓↓↓ IŠTRINK MANE ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
      window.localStorage.setItem(this.root, JSON.stringify(this.data));
    } // ↑↑↑↑↑↑↑↑↑↑↑ IŠTRINK MANE ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
  }
