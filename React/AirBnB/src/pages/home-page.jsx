...
const collapsableContentExtended = (
  <>
    Rūta - užupietė, litvakų istorijos žinovė;
    <br />
    Ieva - diplomuota maisto ekspertė, aktyvaus laisvalaikio entuziastė.
    <br />
    Visi mes esame aktyvūs įvairių vietinių bendruomenių nariai.
    <br />
    Mūsų teikiamos patirtys yra išjaustos, sukurtos ir nuolat tobulinamos mūsų pačių
    - visada surandant tvarų ryšį su vietos bendruomene ir joje veikinačiais mažais verslais.
    <br />
    Atvykite giliau pažinti mūsų mylimą ir puoselėjamą Užupio Respubliką - jos istoriją,
    kasdienybę, džiaugsmus ir iššukius.
  </>
);
    ...
    <Box component="section">
      ...
      <Box sx={{ fontFamily }}>
        <Box sx={{ display: 'flex', mb: 3 }}>
          ...
          <Box>
            ...
            <Typography
              ...
              variant="subtitle1"
              sx={{
                lineHeight: 1, pt: 1, color: '#717171', fontFamily,
              }}
            >
        ...
        <Typography paragraph sx={{ fontFamily }}>
          Sveiki, mano vardas Kęstutis aš esu giliai į Vilnių šaknis įleidęs užupietis.
          <br />
          Kartu su mano svetingiausiomis draugėmis Vilija, Viktorija, Rūta ir Ieva esame grupė,
          kuri turi bendrą aistrą - savo svečiams įgyvendinti unikalius miesto ir priemiesčio
          nuotykius.
          <br />
          Kęstutis - rinkodaros entuziastas, Respublikos Vyriausybės narys;
          {' '}
          <br />
          Vilija - keliautoja, smagurė, dainuojančios revoliucijos kartos narė;
          {' '}
          <br />
          Viktorija - istorikė, keliautoja, laisva narė;
          {' '}
          <br />
          {content}
        </Typography>
